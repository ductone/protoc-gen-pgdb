...
func file_models_animals_v1_animals_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_models_animals_v1_animals_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Pet); i {
			case 0:
				return &v.state
			case 1:
		...
		file_models_animals_v1_animals_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_models_animals_v1_animals_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*EBook); i {
			case 0:
				return &v.state
			case 1:
		...
		file_models_animals_v1_animals_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_models_animals_v1_animals_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Book); i {
			case 0:
				return &v.state
			case 1:
		...
		file_models_animals_v1_animals_proto_msgTypes[5].Exporter = func(v any, i int) any {
