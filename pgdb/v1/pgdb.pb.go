...
const (
	...
	// Must be a minhash.
	FieldOptions_MESSAGE_BEHAVIOR_MIN_HASH FieldOptions_MessageBehavior = 6
)
...
type FieldOptions struct {
	...
	xxx_hidden_MinhashSize     int32                        `protobuf:"varint,6,opt,name=minhash_size,json=minhashSize,proto3"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *FieldOptions) GetMinhashSize() int32 {
	if x != nil {
		return x.xxx_hidden_MinhashSize
	}
	return 0
}
...
func (x *FieldOptions) SetMinhashSize(v int32) {
	x.xxx_hidden_MinhashSize = v
}
...
func (b0 FieldOptions_builder) Build() *FieldOptions {
	...
	x.xxx_hidden_MinhashSize = b.MinhashSize
	return m0
}
...
const file_pgdb_v1_pgdb_proto_rawDesc = "" +
	...
	"\x1ePARTITIONED_BY_DATE_RANGE_YEAR\x10\x03\"\xc0\x06\n" +
	"\fFieldOptions\x12H\n" +
	...
	"\fminhash_size\x18\x06 \x01(\x05R\vminhashSize\"\x85\x01\n" +
	...
	"\x15FULL_TEXT_WEIGHT_HIGH\x10\x03\"\xe3\x01\n" +
	...
	"\x1aMESSAGE_BEHAVIOR_INET_ADDR\x10\x05\x12\x1d\n" +
	"\x19MESSAGE_BEHAVIOR_MIN_HASH\x10\x06J\x04\b\x04\x10\x05R\vvector_size\"3\n" +
